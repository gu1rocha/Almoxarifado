let DownloadPedido = (pedido) => {
    ...
    let data = new Date(pedido.dataCreat)
    ...
    async function showProdtosPedido(produtos){
    ...
    async function carregarDados (){
        ...
        await showProdtosPedido(pedido.produtos)
        ...
        addFooters(doc)
        doc.save(`Pedido ${leftPad(pedido.numero,6)}`);
    }
    carregarDados()
}